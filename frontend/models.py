...
class Profile(models.Model):
    ...
    payeer = models.CharField(max_length=9, blank=True, null=True)
    perfectmoney = models.CharField(max_length=9, blank=True, null=True)
...
class Ad(models.Model):
    ...
    site_balance = models.FloatField(default=0.00)
